    ...
    <div class="container">
        ...
        <div class="text_block-wrapper">
            ...
            <div class="text_block">
                ...
                <p><b>Замена в колодце</b> от 6000₽</p>
                <p><b>Установка в квартире</b> от 4000₽</p>
                <p><b>Установка в доме</b> от 8000₽</p>
    ...
    <div class="container">
        ...
        <div class="faq_wrapper">
                ...
                <div class="faq_item text_block">
                    <p><b>«Городская служба измерений»</b> проводит поверку счетчиков воды в Ростове-на-Дону,
                        Аксае и Батайске. Процесс необходим для выполнения. Владельцу помещения следует уделить ему особое 
                        внимание. Согласно 13 ст. Федеральным законом от 26 июня 2008 г. № 102 от 26.06.2008 и ст. 34 
                        «Правил предоставления коммунальных услуг», метрологическая поверка счетчиков холодной воды в Ростове-на-Дону 
                        должна производиться один раз в 6 лет, а горячей один раз в 4 года. Также можно узнать сроки поверки счетчиков на воду в:</p>
                    <ul>
                        <li>на квитанции об оплате жилищно-коммунальных услуг</li>
                        <li>в Водоканале</li>
                        <li>в управляющей компании</li>
                    </ul>
                    <p>При обнаружении неисправностей при работе измерительного прибора, он должен быть заменен на новый. Вы можете заказать 
                        поверку счетчика на воду у нашей организации, по выгодной цене по сравнению с конкурентами в Ростове-на-Дону.</p>
                    <p>Для оформления заявки достаточно заполнить форму обратной связи. С вами свяжутся наши специалисты и обсудят все детали и вопросы. 
                        Имеем все необходимые сертификаты.</p>
                </div>
...
Для того чтобы заказать поверку счетчика у нашей компании, достаточно просто заполнить форму для обратной связи. С вами свяжутся специалисты и обсудят все детали и вопросы. Имеем все необходимые сертификаты.</p>
                </div>

                <div class="faq_item text_block">
                    <p>Что собой представляет поверка счетчика воды:

Метрологическая поверка счетчика воды в Ростове-на-Дону – это процесс, в ходе которого специалист метрологической службы определяет, насколько точно работает счетчик. Затем данные проверки сравниваются с данными, указанными в паспорте. Если погрешность устройства учета воды выше нормы, дальнейшая эксплуатация будет невозможна. Когда счетчик на воду работает в пределах нормы — это означает, что прибор проверен и может быть использован до следующего срока. Как работает процесс проверки в нашей организации. Поверку воды выполняют в домашних условиях без демонтажа – этот процесс проще, удобнее и быстрее.
Для того чтобы заказать поверку счетчика у нашей компании, достаточно просто заполнить форму для обратной связи. С вами свяжутся наши специалисты и обсудят все детали и вопросы. Имеем все необходимые сертификаты.</p>
                </div>

                <div class="faq_item text_block">
                    <p>Почему счетчик воды стоит заказать у нас?

Основные преимущества обращения в «Городскую измерительную службу»:

Наличие аккредитации, которая позволит нам оказывать метрологические услуги;
Проведение работ без демонтажа;
Разумные цены в отличие от других компаний и скидки для льготных категорий граждан;
Поверка счетчика воды занимает до 20 минут;
Мы выполняем свою работу семь дней в неделю;
Вы можете оставить заявку для заказа метрологической поверки счетчика воды в Ростове-на-Дону на сайте в любое время.
Для того чтобы заказать поверку счетчика на воду у нашей компании, достаточно просто заполнить форму для обратной связи. С вами свяжутся наши специалисты и обсудят все детали и вопросы. Имеем все необходимые сертификаты.</p>
                </div>
