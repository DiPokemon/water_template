...
<section>
    <div class="container">
        <div class="about-wrapper">
          ...
          <p>Компания «Городская служба измерений» работает с лучшими специалистами аккредитованного метрологического центра в Ростове-на-Дону
             <a class="color_red" href="https://poverkadoma.ru">ООО «МС Ресурс»</a>.</p>
          <p>Наша компания выполняет метрологическую поверку счетчиков воды в городах: Ростов-на-Дону, Азов, Батайск по самым приемлемым ценам. 
            И обладает необходимыми сертификатами и аккредитацией.</p>
          </div>
